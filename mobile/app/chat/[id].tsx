          ...
          <View className="px-3 pb-3 pt-2 bg-surface border-t border-surface-light">
            <View className="flex-row items-end bg-surface-card rounded-3xl px-3 py-1.5 gap-2">
              ...
              <TextInput
                ...
                className="flex-1 text-foreground text-sm mb-1 mt-1 pt-1"
                multiline
                style={{ maxHeight: 100 }}
                value={messageText}
              ...
              <Pressable
                className="w-10 h-10 rounded-full items-center justify-center bg-primary mb-1"
                onPress={handleSend}
              ...
              >
                {isSending ? (
                  ...
                  <Ionicons name="send" size={20} color="#0D0D0F" />
                )}
              </Pressable>
            </View>
          </View>
